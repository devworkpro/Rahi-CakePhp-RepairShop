			    ...
			    <form class="ui form">
			        ...
			        <label for=""> <?php echo $user['User']['address'].' '.$user['User']['city'].' '.$user['User']['state_country'].' '.$user['User']['zip']; ?></label>
			       	...
			       	<div class="text-right" style="margin-top:-50px;">
			         	...
			         	<label for=""><?php foreach($Invoices as $Inv){?>
						Invoice #         <span> <?php echo ''.$Inv['inv_number'];?></span><br>
						<?php } ?> </label><br>
			        	<label for=""> <?php foreach($Invoices as $Inv) {?>
						Invoice Date  <span><?php echo ''.date('D d-m-Y g:i A',strtotime($Inv['created']));?></span><br>
						<?php } ?> </label><br>
			        ...
			        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped custom-table-code table-bordered table-responsive">
						...
						<tr class="print-hide">
							...
							<tbody>
								...
								<tr><?php foreach($Invoices as $Inv) {  $amount_provided=$Inv['amount_provided']?>
					...
					<div class="two fields" style="margin-top:100px;">
				        ...
				        <div class="text-left" >
							<?php $signature = $Invoices['Invoice']['signature'];?>
							<?php
								if($signature!=''){
								?>
    						...
    						<div class="panel-body">
								...
								<div class="row">  
									...
									<div class="form-group">
										...
										echo $this->Html->link(ucfirst($user_name),array('controller' => 'users', 'action' => 'userdetail',$user_id),array('escape'=>false,));?><br>
    						...
    						<?php  $status = $Inv['status'];
                     		...
                     		?> 
								...
								<div class="row">  
									...
									<b>Invoice Number:  </b><span><?php echo $Inv['inv_number'];?>
									</span><br>
									<b>Linked Ticket: </b><?php $ticket_id=$Inv['ticket_id'];
									if($ticket_id!='0')
									{
									...
									?>
									<br>
									<b>Linked Estimate: </b><?php $estimate_id=$Inv['estimate_id'];
									if($estimate_id!='0')
									{
									...
									?><br>
									<b>Due Date: </b><?php echo $Inv['due_date'];?><br>
									<b>Po Number: </b>
										<span class="ponumber">
									...
									<b>Tax Rate: </b><?php echo $Inv['tax_rate'];?><br>	
									<b>Paid:</b><td>
									<?php  $status = $Inv['status'];
                     				if($status=='1')
                   					{
									...
									<b>Date Paid: </b><?php echo $Inv['paid_date'];?><br>
									<b>Sub Total: </b><?php echo '$'.$Inv['total'];?><br>
									<b>Total: </b><?php echo '$'.$Inv['total'];?><br>
									<b>Ref Number: </b><?php echo $Inv['ref_number'];?><br>
											...
											<div class="form-group">
												...
												<?php echo $this->Form->create('Sale',array('controller'=>'sales','action'=>'addsalemanualy','class'=>"validator-form")); ?>
													...
													<div class="row">                 
														...
														<?php echo $this->Form->input('Sale.cost', array('type'=>'number','class'=>'form-control','label'=>'Cost','required'=>'required')); ?>
														</div>
														</div>
													</div>
...
$('.submit').click(function(){
		...
		if(po_number!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Invoices/invoiceupdate/",
...
//alert(total);alert(invoice_id);die();
		if(total!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Invoices/updateinvoice/",
...
//alert(item);alert(invoice_id);die();
		...
		if(item!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Invoices/updateinvoiceitem/",
...
$(document).ready(function(){
	...
	$('#product_name').keyup(function(){
		...
		if(searchid!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Invoices/inventory/",
...
$('.submitqty').click(function(){
		...
		if(qty!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Invoices/saleinvoiceupdateqty/",
...
id = $(this).attr('id');
		...
		if(des!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Invoices/saleinvoiceupdatedes/",
...
id = $(this).attr('id');
		...
		if(item!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Invoices/saleinvoiceupdateitem/",
...
$('.submitrt').click(function(){
		...
		if(rt!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Invoices/saleinvoiceupdaterate/",
