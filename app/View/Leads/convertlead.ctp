                ...
                <div class="panel-body">
                	<div class="">
							...
							<div class="col-xs-6 text-right">
								...
								<a class="btn btn-success btn-sm" data-toggle="modal" href="#myEmail">New Email</a>


								 <a class="btn btn-default btn-sm" data-toggle="modal" href="#myAttachment">Add File</a>
				                ...
				                <div class="row">                 
				                    <div class="col-xs-12 col-sm-12">
										<div class="form-group">
				                 		...
				                 		<?php echo $this->Form->input('Lead.business_name', array('type'=>'hidden','class'=>'form-control','value'=>$this->Session->read('User_id'), 'name'=>'User[login_id]')); ?>
										</div>
				                    </div>
				                </div>
...
$(document).ready(function(){
	...
	$('#get_data').keyup(function(){
		...
		if(searchid!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Leads/lead/",
...
var lead_id = $('#id').val();
  // alert(assignee);alert(lead_id);die();       
    if(assignee!='')
    {
         $.ajax({
         type: "POST",
         url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Leads/assigneeupdate/",
