...
<div class="warper container-fluid">
  <div class="page-header"><h1><?php echo $this->Html->link('Edit Estimate', array('controller' => 'Estimates', 'action' => 'editingestimate', 'admin' => true),array('escape' => FALSE)); ?></h1></div>
    <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="row">                 
            ...
            <?php echo $this->Form->input('Estimate.ticket', array('type' => 'select','div'=>false,'class'=>'form-control','label'=>'Related Ticket')); ?>
        ...
        <div class="row">                 
          ...
          <hr class="dotted">
           ...
           <div class="btn-group">
            ...
            <div class="btn-group">
              <?php echo $this->Html->link('Back',array('controller' => 'Estimates', 'action' => 'estimatelist'),array('escape'=>false));?>
            </div>
          </div>
        </div>
