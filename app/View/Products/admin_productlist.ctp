...
$(document).ready(function() {
    ...
    $(document).on('click', '.submitqty', function() {
        ...
        if(qty!='')
        {
            $.ajax({
            type: "POST",
            url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Products/updateproductquantity/",
...
$(document).ready(function() {
    ...
    $(document).on('click', '.submitcost', function() {
        ...
        if(cost!='')
        {
            $.ajax({
            type: "POST",
            url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Products/updateproductcost/",
...
$(document).ready(function() {
    ...
    $(document).on('click', '.submitretail', function() {
        ...
        if(retail!='')
        {
            $.ajax({
            type: "POST",
            url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Products/updateproductretail/",
