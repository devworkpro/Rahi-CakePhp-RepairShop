<?php echo $this->Flash->render('positive'); ?> 
 <?php $counter=0;$i=0;$j=0;$resolve=0;?>
  <?php foreach($Tickets as $tic) {

  if($tic['Ticket']['status']=="Resolved")
  {
    $resolve = $resolve+1;
  }
  else
 ...
 <div class="warper container-fluid" style="margin-bottom:50px; margin-top:10px;"> 
    ...
    <span class="pull-right">
      ...
      <button class="btn btn-primary btn-sm viewResolved"> View Resolved </button>
      <button class="btn btn-primary btn-sm viewPending"> Vew Pending </button> 
        ...
        <div class="panel-body">
            ...
            <table id="example" class="display table" style="width: 100%; cellspacing: 0; ">
                ...
                <tbody>
                          ...
                          <?php foreach($Tickets as $tic) {
                            $TicStatus = $tic['Ticket']['status'];
                          if($TicStatus=="Resolved")
                          {                            

                            
                            ?>
                          <tr class="ResolvedTickets">
                          <?php $row_id =  ++$counter;?>
                          ...
                          <?php $user_id= $tic['Ticket']['user_id'];?>
                            ...
                            <td><?php 
                              echo  $date = date('d-m-Y',strtotime($tic['Ticket']['created']));?></td> 
                            <td>
