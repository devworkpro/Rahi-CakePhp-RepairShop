          ...
          <h4 class="modal-title"></h4><div class="btn btn-default btn-sm" id="create_pdf">Save PDF</div>
    		...
    		<div class="modal-body">
       		<div class="segment" id="pdfdiv1" >
		        ...
		        <label for=""> <?php echo $user['User']['address'].' '.$user['User']['city'].'<br> '.$user['User']['state_country'].' '.$user['User']['zip']; ?></label>
								...
								<div class="panel panel-default">
            						...
            						<div class="panel-body">
										...
										<div class="row">  
											<div class="col-xs-12 col-sm-12">
											<div class="form-group">
												<?php 	$approved= $tic['approved'];
														$diagnosed= $tic['diagnosed'];
													 	$invoiced= $tic['invoiced'];
...
//alert(tic_id); alert(type);die();
    ...
    if(type!='')
    {
        $.ajax({
	        type: "POST",
	        url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Tickets/typeupdate/",
...
//alert(tic_id); alert(address);die();
    ...
    if(address!='')
    {
         $.ajax({
         type: "POST",
         url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Tickets/addressupdate/",
...
//alert(contract_value);alert(tic_id); alert(contract);die();
    ...
    if(contract!='')
    {
         $.ajax({
         type: "POST",
         url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Tickets/contractupdate/",
...
//alert(sla_value);alert(tic_id); alert(sla);die();
    ...
    if(sla!='')
    {
         $.ajax({
         type: "POST",
         url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Tickets/slaupdate/",
...
$(document).ready(function(){
	$('#CustomFieldName').change(function(){
	 	var CustomFieldId = $(this).val();
			...
			$.ajax({
       			type: 'POST',
      			url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Tickets/customfieldtypemodel/",
