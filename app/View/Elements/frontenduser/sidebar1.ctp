...
$(document).ready(function(){
    ...
    $(".tabs-left ul li.active").attr("class","");
    ...
    <div class="col-xs-3">
        <div class="panel panel-white">
            <div class="panel-heading">
                <h3 class="panel-title">Settings Pages</h3>
            ...
            <div class="panel-body">
                <div class="tabs-left">
                    <ul class="nav">    
                        ...
                        <li class="active">
                        <?php echo $this->Html->link('General Settings',array('controller'=>'Administrations','action'=>'general'),array('escape'=>false));?>
                        
                        </li>
                        <li>
                        <?php echo $this->Html->link('Tabs Settings',array('controller'=>'Administrations','action'=>'tabs'),array('escape'=>false));?>
                        
                        </li>
                        <li>
                        <?php echo $this->Html->link('Customer Settings',array('controller'=>'Administrations','action'=>'customer'),array('escape'=>false));?>
                        
                        </li>
                        <li>
                        <?php echo $this->Html->link('Invoice Settings',array('controller'=>'Administrations','action'=>'invoice'),array('escape'=>false));?>
                        </li>
                        <li>
                        <?php echo $this->Html->link('Estimates Settings',array('controller'=>'Administrations','action'=>'estimates'),array('escape'=>false));?>
                        </li>
                        <li>
                        <?php echo $this->Html->link('Tickets Settings',array('controller'=>'Administrations','action'=>'tickets'),array('escape'=>false));?>
                        </li>
                        <li>
                        <?php echo $this->Html->link('Parts Settings',array('controller'=>'Administrations','action'=>'parts'),array('escape'=>false));?>
                        </li>
                        <li>
                        <?php echo $this->Html->link('Inventory Settings',array('controller'=>'Administrations','action'=>'inventory'),array('escape'=>false));?>
                        </li>
                        <li>
                        <?php echo $this->Html->link('POS Settings',array('controller'=>'Administrations','action'=>'pos'),array('escape'=>false));?>
                        <li>
                        <?php echo $this->Html->link('Leads Settings',array('controller'=>'Administrations','action'=>'leads'),array('escape'=>false));?>
                        </li>
                        <li>
                        <?php echo $this->Html->link('Employee Settings',array('controller'=>'Administrations','action'=>'employee'),array('escape'=>false));?>
                        </li>
