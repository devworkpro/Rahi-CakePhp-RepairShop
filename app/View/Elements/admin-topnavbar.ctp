<div class="navbar">
                <div class="navbar-inner container">
                    ...
                    <div class="logo-box">
                        ...
                        <?php echo $this->Html->link('Repair Shop',array('controller'=>'pages','action'=>'dashboard'),array('escape'=>false,'class'=>'logo-text'));?>
                    </div><!-- Logo Box -->
                    ...
                    <div class="topmenu-outer">
                        <div class="top-menu">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                    	<span class="user-name"><?php echo $this->Session->read('Auth.User.first_name');?><i class="fa fa-angle-down"></i></span>
                                        <img class="img-circle avatar" src="<?php echo $this->webroot.'images/avatar1.png'?>" width="40" height="40" alt="">
                                    </a>
                                    <ul class="dropdown-menu fonts/glyphicons-halflings-regular.woff2-list" role="menu">
                                        <li role="presentation"><a href="profile.html"><i class="fa fa-user"></i>Profile</a></li>
                                       
                                        <li><?php echo $this->Html->link('<i class="glyphicon glyphicon-calendar"></i> Calendar',array('controller'=>'Calendars','action'=>'add'),array('escape'=>false));?></li>
                                        ...
                                        <li role="presentation"><?php echo $this->Html->link('<i class="fa fa-sign-out m-r-xs" role="presentation"></i>Log out',array('controller'=>'users','action'=>'logout'),array('escape'=>false));?></li>
                                    </ul>
                                </li>
                                <!-- <li>
