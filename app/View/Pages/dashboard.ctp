        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                <div class="panel panel-white">
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-md-2">
                            <?php echo $this->Html->link('<i class="fa fa-barcode"></i>',array('controller'=>'#','action'=>'add'),array('escape'=>false,"class"=>'btn btn-default btn_link'));?>
                        </div>
                        <div class="col-lg-9 col-md-9">
            ...
            <div class="panel panel-default reminder">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title" style="float: left;"><i class="fa fa-clock-o"></i>  <?php echo $this->Html->link('Reminders',array('controller' => 'Reminders', 'action' => 'reminderlist'),array('escape'=>false));?>    &nbsp;&nbsp;</h4>  <a href="#myReminderModal" data-toggle="modal" style="font-size:15px;">            <span class="glyphicon glyphicon-plus"></span>
                        </a> 
