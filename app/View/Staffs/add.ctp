...
?>
<?php
if(!empty($totalStaff_count))
{
  ?>
  <div class="totalStaff_count" style="display: none;"><?php echo $totalStaff_count;?></div>
  <?php
}
?>
      ...
      <div class="row">                 
        ...
        <div class="col-xs-12 col-sm-6">
          ...
          <div class="form-group">
            ...
            <?php echo $this->form->Submit("Create Staff",array('class'=>'btn btn-success pull-right create_staff_btn')); ?>
          </div>
        </div>  
...
<script type="text/javascript">
  $(document).ready(function() {
      ...
      var totalStaff_count = $(".totalStaff_count").text();
  		//alert(totalStaff_count);
  		if(datediff > 0)
      {
      }
      else{
        if(totalStaff_count < 1)
        {
