      ...
      <div class="row">                 
        ...
        <div class="col-xs-12 col-sm-6">
					...
					<div class="form-group pull-right">
						...
						<div class="btn-group">
							<?php echo $this->form->Submit("Update Staff",array('class'=>'btn btn-success pull-left')); ?>
						</div>
						<div class="btn-group">
	                 	...
	                 	<div class="btn-group">
	                   		...
	                   		<?php echo $this->Html->link('<i class="fa fa-arrow-left"></i>Back',array('controller' => 'staffs', 'action' => 'index'),array('escape'=>false,'class'=>'btn btn-primary'));?>
	                   	</div>
					</div>
        </div>
			</div>
