        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
 					<h2>New item</h2>
					<?php echo $this->Form->create('Part',array('controller'=>'Parts','action'=>'add','id'=>"wizardForm")); ?>
						
					
					<div class="row">                 
                    	<div class="col-xs-12 col-sm-12">
							<div class="form-group">
								<?php echo $this->Form->input('Part.login_id', array('type'=>'hidden','div'=>false,'class'=>'form-control','value'=>$this->Session->read('Auth.User.id'))); ?>
								 <?php if(!empty($new_ticket)) {?>
							<label>Ticket  </label> <br>
						
								
                                 
								<?php  echo $this->Form->select('Part.ticket_id',$new_ticket,array("escape"=>false,"type"=>"select",	""=>"" ,'class'=>'form-control','required'=>'required')); ?>
							      <?php }?>
