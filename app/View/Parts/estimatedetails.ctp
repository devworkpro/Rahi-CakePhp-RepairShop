	...
	$('#approve').click(function(){
		...
		if(id!='')
		{
 			   ...
 			   url: "/<?php $parentparentdir=basename(dirname(dirname(dirname(dirname(__FILE__)))));
     			echo $parentparentdir; ?>/admin/Estimates/approve/",
...
$(document).ready(function(){
	$('#unapprove').click(function(){
		...
		if(id!='')
		{
 			   ...
 			   type: "POST",
 			   url: "/<?php $parentparentdir=basename(dirname(dirname(dirname(dirname(__FILE__)))));
     			echo $parentparentdir; ?>/admin/Estimates/unapprove/",
...
$(document).ready(function(){
	$('#decline').click(function(){
		...
		if(id!='')
		{
 			   ...
 			   type: "POST",
 			   url: "/<?php $parentparentdir=basename(dirname(dirname(dirname(dirname(__FILE__)))));
     			echo $parentparentdir; ?>/admin/Estimates/decline/",
...
$(document).ready(function(){
	$('#undodecline').click(function(){
		...
		if(id!='')
		{
 			   ...
 			   type: "POST",
 			   url: "/<?php $parentparentdir=basename(dirname(dirname(dirname(dirname(__FILE__)))));
     			echo $parentparentdir; ?>/admin/Estimates/undodecline/",
...
$(document).ready(function(){
	$('#get_data').keyup(function(){
		...
		if(searchid!='')
		{
 			   ...
 			   type: "POST",
 			   url: "/<?php $parentparentdir=basename(dirname(dirname(dirname(dirname(__FILE__)))));
     			echo $parentparentdir; ?>/admin/Estimates/inventory/",
...
id = $(this).attr('id');
		...
		if(qty!='')
		{
 			   ...
 			   type: "POST",
 			   url: "/<?php $parentparentdir=basename(dirname(dirname(dirname(dirname(__FILE__)))));
     			echo $parentparentdir; ?>/admin/Estimates/inventoryupdate/",
...
var est_id =$("#est_id").text();
		if(total!='')
		{
 			   ...
 			   type: "POST",
 			   url: "/<?php $parentparentdir=basename(dirname(dirname(dirname(dirname(__FILE__)))));
     			echo $parentparentdir; ?>/admin/Estimates/updateestimate/",
...
var est_id =$("#est_id").text();
		if(item!='')
		{
 			   ...
 			   type: "POST",
 			   url: "/<?php $parentparentdir=basename(dirname(dirname(dirname(dirname(__FILE__)))));
     			echo $parentparentdir; ?>/admin/Estimates/updateestimateitem/",
