<title>Repair shoppe | Business Setting</title>
  ...
  <div class="page-inner">
    <div id="main-wrapper" >
      <div class="row">
        ...
        <div class="login-box">
         <a href="http://112.196.42.180/projects/repairshopsaas/repairshopsaas/" class="logo-name text-lg text-center">Repair Shoppe</a> 
          <h3 class="text-center m-t-md">Business Settings<hr></h3>
      ...
      <div class="col-xs-6 bhv-showOther">
        <div class="form-group string required quick_start_other_typed"><label class="string" for="quick_start_other_typed">Other</label><input class="string form-control bhv-otherCategory" style="max-width: 200px;" name="BusinessSetting[other_categories]" type="text"></div>
      </div>
