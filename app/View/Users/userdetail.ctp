...
<?php $invcount=0;$paid_inv=0;$unpaid_inv=0;$paid_inv_total=0;$unpaid_inv_total=0;$inv_total=0;?>
  <?php foreach($invoice as $inv) {?>
    <?php  ++$invcount;?>
    <?php $inv_total = $inv_total + $inv['Invoice']['total'];?>
	...
	<div class="page-header">
  		...
  		<span class="pull-right">
	        ...
	        <ul class="dropdown-menu">
	            ...
	            <li><?php echo $this->Html->link('<p class="menu-default">Ticket</p>',array('controller'=>'Tickets','action'=>'newnew',$user_id),array('escape'=>false));?></li>
	            <li><?php echo $this->Html->link('<p class="menu-default">Payment</p>',array('controller'=>'Payments','action'=>'paymentlist'),array('escape'=>false));?></li>
		...
		<!-- Modal content-->
			...
			<?php echo $this->Form->create('users',array('controller'=>'Users','action'=>'addappointment')); ?> 
				...
				<?php echo "Customer :   ".$customer_name = $userDetail['User']['first_name']." ".$userDetail['User']['last_name']; ?>
						...
						<?php echo $this->Form->input('Appointment.login_id', array('type'=>'hidden','class'=>'form-control', 'value'=>$this->Session->read('Auth.User.id'))); ?>
				</div>
				</div>
				</div>
				<div class="row">                 
...
<div class="row">
	...
	<div class="col-md-6 communication_log">
	<div class="panel panel-default">
	    ...
	    <div class="panel-body">
	        ...
	        <table class="table table-hover table-bordered">
				...
				<?php }?>
				<tr><td colspan="4"><?php echo $this->Html->link("More",array('controller' => 'users', 'action' => 'communicationlog_list',$user_id),array('escape'=>false));?></td></tr>
	            </tbody>
	        </table>
	       	</div>
	    </div>
		...
		<!-- Modal content-->
			...
			<?php echo $this->Form->create('Users',array('controller'=>'users','action'=>'addnewreminder')); ?> 
				...
				<div class="form-group">
					...
					<?php echo $this->Form->input('Reminder.login_id', array('type'=>'hidden','div'=>false,'class'=>'form-control','value'=>$this->Session->read('Auth.User.id'))); ?>
				</div>
				</div>
				</div>
			   	<div class="row">                 
	...
	<!-- Recurring Invoices -->
	<div class="col-md-6 recurring_invoice">
	<div class="panel panel-default ">
	    <div class="panel-heading clearfix">
	        <h4 class="panel-title"><i class="fa fa-money"></i>     Recurring Invoices/Subscriptions &nbsp;&nbsp;</h4>
	        <?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>',array('controller' => 'Schedules', 'action' => 'newnew','?' => array('user_id' => $user_id)),array('escape'=>false));?> 	
	    </div>
	    <div class="panel-body">
	    	<div class="table-responsive">
	        <table class="table table-hover table-bordered">
	...
	<!-- Portal Users -->
	<div class="col-md-6 portal_users">
	<div class="panel panel-default ">
    <div class="panel-heading clearfix">
	...
	<div class="panel panel-default ">
	    ...
	    <div class="panel-body">
	        ...
	        <table class="table table-hover table-bordered">
	            ...
	            <tbody>
	            <?php foreach ($InvoicePayment as $inv) {
				?>
				<tr>
					<td><?php echo $inv['InvoicePayment']['payment_date'];?></td>
					<td><?php echo '$'.$inv['InvoicePayment']['payment_amount'];?></td>
					<td><?php echo $inv['InvoicePayment']['payment_method'];?></td>
					<td><?php echo $inv['InvoicePayment']['invoices'];?></td>
					<td><?php echo $inv['InvoicePayment']['reference_number'];?></td>
				</tr>
				<?php } ?>
				<tr><td colspan="5"><?php echo $this->Html->link("More",array('controller' => 'Payments', 'action' => 'invoicepaymentlist'),array('escape'=>false));?></td></tr>
	            </tbody>
	        </table>
	...
	<!-- Change History  -->
	<!-- <div class="col-md-6 changehistory">
	<div class="panel panel-default">
	    <div class="panel-heading clearfix">
...
$('.notes_submit').click(function(){
		...
		if(notes!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Users/notesupdate/",
...
$(document).ready(function() {
	$('#addnewcontact').click(function(){		
		...
		$.ajax({
 			type: "POST",
 			url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Users/addnewcontact/",
...
$(document).ready(function() {
	...
	$('#addnewportaluser').click(function(){	
		...
		$.ajax({
 			type: "POST",
 			url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PortalUsers/addNewPortalUser/",
...
$(document).ready(function() {
  ...
  $(document).on('change', '.select_customer', function() {
      ...
      //alert(portaluser_id);alert(customer);die();
         ...
         $.ajax({
         type: "POST",
         url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PortalUsers/updatecustomer/",
...
$(document).ready(function() {
	...
	$('.submit_login').click(function(){
		...
		if(login!='')
		{
		   	$.ajax({
		   		type: "POST",
		   		url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PortalUsers/updatelogin/",
	...
	$('.portal_user_btn').click(function(){
	    ...
	    if(pass1==pass2){
	    	if(portaluser_id!='')
			{
			   	$.ajax({
			   		type: "POST",
			   		url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PortalUsers/updatepassword/",
...
$(document).ready(function() {
  ...
  $(document).on('click', '.status', function() {  
        ...
        if(status=="Reactive")
        {
          ...
          $.ajax({
                  type: "POST",
                  url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Reminders/statusupdate/",
