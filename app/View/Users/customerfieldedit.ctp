...
<div class="row">  	
	...
	<div class="col-xs-8 col-sm-8">
		...
		<div class="page-header">
			<h1>Edit Customer Field<small></small>
...
<div class="row">
	...
	<div class="col-xs-12 col-sm-12">
		<?php echo $this->Form->create('users',array('controller'=>'Users','action'=>'customerfieldsedit','class'=>'validator-form')); ?>
		...
		<div class="row">  
        	...
        	<div class="col-xs-12 col-sm-8">
				<div class="form-group">
			 		...
			 		<?php echo $this->Form->input('CustomerField.id', array('type'=>'hidden','class'=>'form-control')); ?>
