        ...
        <div class="row">                 
          ...
          <div class="col-xs-12 col-sm-12" style="text-align: center;">
            ...
            <div>
              ...
              <br>
              <div class="row">
                <a href="#myAttachmentModal" data-toggle="modal" class='btn btn-primary btn-lg' > Add New Logo</a>
              </div>
            </div>
          </div>
...
<div class="modal fade" id="myAttachmentModal" role="dialog">
  ...
  <!-- Modal content-->
    ...
    <div id="main-wrapper" class="container">
      <?php echo $this->Form->create('users',array('controller'=>'users','action'=>'logo','class'=>'validator-form','enctype' => 'multipart/form-data','id'=>"wizardForm")); ?>
