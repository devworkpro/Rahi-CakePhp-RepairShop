	...
	<div class="col-lg-12">
        ...
        <div class="tab-content">
			...
			<div class="row">                 
				...
				<div class="col-xs-12 col-sm-6">
					<div class="form-group">
						<?php echo $this->Form->input('User.address2', array('div'=>false,'class'=>'form-control','placeholder'=>'Address 2' ,'id'=>'pac-input')); ?> 
					</div>
				</div>
            ...
            <div class="row">     
                ...
                <div class="col-xs-12 col-sm-6">
					<div class="form-group">
						<?php echo $this->Form->input('User.zip', array('autocomplete' => 'off','div'=>false,'class'=>'form-control', 'minlength'=>"6",'maxlength'=>"6", 'placeholder' => 'Postal Code','id'=>'postal_code')); ?>
			...
			<div class="row">    
                ...
                <div class="col-xs-6 col-sm-6">
					<div class="form-group">
						<div id="map" style="width:450px;height:470px;margin-top: 10px;"></div>
...
<script>
    ...
    $(wrapper).on("click","#save_phone_btn", function(e){ //user click on remove text
        ...
        $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/users/addnewuserphone/",
...
<script>
    ...
    $(wrapper).on("click","#save_address_btn", function(e){ //user click on remove text
        ...
        $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/users/addnewuseraddress/",
...
$(document).ready(function(){
    $(".addressupdate").click(function(){
        ...
        var addressid = $("#addressid_"+id).val();
  		...
  		$.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/users/useraddressedit/",
...
$(document).ready(function(){
    $(".delete_phone").click(function(){
        ...
        //alert("The paragraph was clicked.");die();
  		...
  		$.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/users/userdeletephone/",
...
$(document).ready(function(){
    $(".phoneupdate").click(function(){
        ...
        var phoneid = $("#phoneid_"+id).val();
  		...
  		$.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/users/userphoneedit/",
