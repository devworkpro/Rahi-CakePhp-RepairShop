...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Create Scatter Course</h3>
          </div><!-- /.box-header -->
          <!-- form start -->
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <?php echo $this->Form->input('Course.required_control', array('div'=>false,'class'=>'form-control','placeholder' => 'Required Controls')); ?>
               <span style="color:red;" class="controlError"></span>
            </div>
          ...
          <div class="box-footer">
            <?php echo $this->form->Submit("Save",array('class'=>'btn btn-primary','id'=>'scatterCreate')); ?>
           </div>
           <div class="box-footer">
    ...
    <script src="<?php echo $this->webroot.'js/backend/create_course_scatter.js';?>"></script>
     <style>
