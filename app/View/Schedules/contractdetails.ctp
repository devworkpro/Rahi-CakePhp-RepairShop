								...
								<div class="col-xs-12 col-sm-12">
									<div class="form-group">
										...
										<span class="service_level_agreement">
                             				<?php $service_level_agreement = $Contract['Contract']['service_level_agreement']; ?>
                             				<?php if($service_level_agreement!=''){
											?>
											
											<span class="service_level_agreement_edit best_in_place">
												<?php echo $service_level_agreement;?>
                             				</span>
		                                ...
		                                <div style="display:none;" class="service_level_agreement_form" >
			                                ...
			                                <form action="javascript:void(0);">
			                                    <select class="service_level_agreement_select form-control">
			                                        <option>Yes</option>
			                                        <option>No</option>
	...
	$('.service_level_agreement_select').change(function() {
	    ...
	    if(service_level_agreement!='')
	    {
	        ...
	        success: function(data)
	        {
	            ...
	            $(".service_level_agreement_edit").append(service_level_agreement);
