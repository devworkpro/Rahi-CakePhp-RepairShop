                    ...
                    <td>
                      ...
                      <span style="display:none;" class="quantity_form_<?php echo $row_id;?>" id="<?php echo $row_id; ?>" >
                        <form class="place" action="javascript:void(0);">
                          ...
                          <input type="text" id="quantity_<?php echo $row_id;?>" class="form-control" value="<?php echo $quantity;?>" required>
                          <input type="hidden"  id="id_<?php echo $row_id;?>" value="<?php echo $Inv['Inventory']['id'];?>">
                      ...
                      <span style="display:none;" class="rate_form_<?php echo $row_id;?>" id="<?php echo $row_id; ?>" >
                        <form class="place" action="javascript:void(0);">
                          ...
                          <input type="text" id="rate_<?php echo $row_id;?>" class="form-control" value="<?php echo $rate;?>" required>
...
$(document).ready(function(){
  ...
  $('#get_data').keyup(function(){
    ...
    if(searchid!='')
    {
        $.ajax({
          type: "POST",
          url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Schedules/inventory/",
...
$('.submitdescription').click(function(){
    ...
    if(description!='')
    {
        $.ajax({
          type: "POST",
          url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Schedules/updatedescription/",
...
$(document).ready(function() {
  ...
  $('.tax_select').change(function() {
      ...
      if(tax!='')
      {
          $.ajax({
          type: "POST",
          url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Schedules/updatetax/",
          // url: "search.php",
...
$('.submitquantity').click(function(){
    ...
    if(quantity!='')
    {
        $.ajax({
          type: "POST",
          url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Schedules/updatequantity/",
...
$('.submitrate').click(function(){
    ...
    if(rate!='')
    {
        $.ajax({
          type: "POST",
          url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Schedules/updaterate/",
