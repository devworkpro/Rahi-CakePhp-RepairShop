                   ...
                   <div class="panel-body">
                    ...
                    <div class="col-xs-12 col-sm-12">
						...
						<?php echo $this->Form->input('Estimate.est_number', array('type'=>'hidden','div'=>false,'class'=>'form-control','value'=>rand(10,10000))); ?>
                   		...
                   		<?php echo $this->Form->input('Estimate.login_id', array('type'=>'hidden','div'=>false,'class'=>'form-control','value'=>$this->Session->read('Auth.User.id'))); ?>
...
$(document).ready(function(){
	...
	$('#get_data').keyup(function(){
		...
		if(searchid!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Estimates/estimate/",
