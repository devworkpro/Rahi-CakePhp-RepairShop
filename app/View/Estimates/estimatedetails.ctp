...
$Line_Items = '<div class="panel panel-default">
          ...
          ';
            ...
            $row_id =  ++$counter;
            $rate= $Inv['Inventory']['rate'];
			$qty = $Inv['Inventory']['quantity'];
			$tax_rate= $Inv['Inventory']['tax_rate']; 
			$price=$qty*$rate;  
            $total=$price+$total;
            $tax=$tax_rate+$tax;
            ...
            $Line_Items .= '<tr>
							<td>'.$row_id.'</td>
			                <td>'.$Inv['Inventory']['item'].'</td>
			                <td>'.$Inv['Inventory']['description'].'</td> 
			                <td>'.$Inv['Inventory']['quantity'].'</td>
			                <td>'.$Inv['Inventory']['rate'].'</td>
			                <td>'.'$'.$price.'</td>
						</tr>';  
			} 							
...
$User_Signature = '';
                if(!empty($Estimates)){
                if($Estimates['Estimate']['signature']!=''){
...
<div class="warper container-fluid" style="margin-bottom:60px;">
	<div class="page-header"><h1>Estimate Details
	    ...
	    {
	    ?>
	    	<?php echo $this->Html->link('Convert to Invoice', array('controller' => 'Estimates', 'action' => 'convertestimatetoinvoice',$id),array('escape' => FALSE,'class'=>"btn btn-success btn-sm" )); ?>
	    	<?php echo $this->Html->link('New Ticket', array('controller' => 'Tickets', 'action' => 'newnew',$Inv['user_id']),array('escape' => FALSE,'class'=>"btn btn-success btn-sm" )); ?>
    ...
    <div class="modal-body">
       	<div class="segment" id="pdfdiv1" >
     		...
     		<form class="ui form">
     		<?php 
     			if(!empty($Estimate_Template))
				{
				//pr($estimatetemplate);die();
				$template_data = $Estimate_Template['Template']['estimate_template'];
				$result        = '';
				...
				if(!empty($Login_user) AND !empty($Estimates) AND !empty($user) AND !empty($Disclaimer))
				{
				...
				$estimate_number    = $Estimates['Estimate']['est_number'];
				$estimate_date      = date('D d-m-Y g:i A',strtotime($Estimates['Estimate']['created']));


				$estimate_subtotal = $Estimates['Estimate']['total'];

				$estimate_tax = $Estimates['Estimate']['tax_rate'];

				$estimate_total = $estimate_subtotal + $estimate_tax;

				$approved_stamp_full_path   = $this->webroot.'img/approved.png';
				$declined_stamp_full_path   = $this->webroot.'img/declined.png';
				$unpaid_stamp_full_path     = $this->webroot.'img/unpaid.png';
				
				if($Estimates['Estimate']['status'] == '1')
			    {
			    	$estimate_stamp = '<img src="'.$approved_stamp_full_path.'" alt="Cover"  width="250" height="50">';
			    }
			    elseif($Estimates['Estimate']['decline'] == '1'){
			    	$estimate_stamp = '<img src="'.$declined_stamp_full_path.'" alt="Cover"  width="250" height="50">';
			    }
			    else{
			    	$estimate_stamp = '<img src="'.$unpaid_stamp_full_path.'" alt="Cover"  width="250" height="50">';
			    }
				...
				//pr($replace);die();
				echo $result         = str_replace($find,$replace,$template_data);
				}
				}   
			?>
			</form>
						...
						<div class="panel panel-default">
    						...
    						<div class="panel-body">
								<div class="row">  
									<div class="col-xs-12 col-sm-12">
									<div class="form-group">
										<?php $user_id=$user['User']['id'];?><br>
										<div class="row">  
										<div class="col-xs-5 col-sm-5">
										<b>Business Name:  <span>
										</span>
										</b>
										</div>
										<div class="col-xs-7 col-sm-7">
										<span><b><?php echo $user['User']['business_name'];?></b></span>
										</div>
										</div><br>
										<div class="row">  
										<div class="col-xs-5 col-sm-5">
										...
										<div class="col-xs-7 col-sm-7"><?php echo $user['User']['email']; ?>
										</div>
										</div><br>
										<div class="row">  
										<div class="col-xs-5 col-sm-5">
										...
										<div class="col-xs-7 col-sm-7"><?php $address= $user['User']['address'].' '.$user['User']['city'].' '.$user['User']['state_country'].' '.$user['User']['zip']; 
										?>
										...
										<div class="col-xs-7 col-sm-7"><?php
										if(!empty($phone)){
											foreach ($phone as $ph) {
										...
										<div class="col-xs-7 col-sm-7"><?php $sms= $user['User']['sms_service'];
										if($sms==1){echo "True";} ?>
										</div>
										</div>
									</div>
						...
						<div class="form-group">
							<div class="panel panel-default">
        						...
        						<div class="panel-body est">
        							...
        							$decline = $Estimates['Estimate']['decline'];
                         				if($status=='1')
                       					{
                         					?><div id="approved">
        							...
        							<div class="row">  
										...
										<div class="col-xs-7 col-sm-7"><span><?php echo $Estimates['Estimate']['est_number'];?></span>
										</div>
										</div><br>
										<div class="row">  
										<div class="col-xs-5 col-sm-5">
										...
										<div class="col-xs-7 col-sm-7"><?php echo date('D d-m-Y g:i A',strtotime($Estimates['Estimate']['created']));?>
										</div>
										</div><br>
										<div class="row">  
										<div class="col-xs-5 col-sm-5">
										...
										<div class="col-xs-7 col-sm-7"><?php $ticket_id=$Estimates['Estimate']['ticket_id'];
										if($ticket_id!='0')
										{
										...
										<div class="col-xs-7 col-sm-7"><?php $invoice_id=$Estimates['Estimate']['invoice_id'];
										if($invoice_id!='0')
										{
										...
										<div class="col-xs-7 col-sm-7"><?php echo $Estimates['Estimate']['created_by'];?>
										</div>
										</div><br>
										<div class="row">  
										<div class="col-xs-5 col-sm-5">
										<p>Non-Taxable Estimate </p>
										</div>
										</div><br>
										<div class="row">  
										<div class="col-xs-5 col-sm-5">
										<b>Tax: </b></div>  
										<div class="col-xs-7 col-sm-7"><?php echo $Estimates['Estimate']['tax'];?>
										</div>
										</div><br>
										<div class="row">  
										<div class="col-xs-5 col-sm-5">	
										...
										<div class="col-xs-7 col-sm-7"><?php echo '$'.$Estimates['Estimate']['total'].".00";?>
										</div>
										</div><br>
										<div class="row">  
										<div class="col-xs-5 col-sm-5">
										...
										<div class="col-xs-7 col-sm-7"><?php echo $Estimates['Estimate']['tech_notes'];?>
										</div>
										</div><br>
...
$(document).ready(function(){
	$('#approve').click(function(){
		...
		if(id!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Estimates/approve/",
...
$(document).ready(function(){
	$('#unapprove').click(function(){
		...
		if(id!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Estimates/unapprove/",
...
$(document).ready(function(){
	$('#decline').click(function(){
		...
		if(id!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Estimates/decline/",
...
$(document).ready(function(){
	$('#undodecline').click(function(){
		...
		if(id!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Estimates/undodecline/",
...
$(document).ready(function(){
	...
	$('#get_data').keyup(function(){
		...
		if(searchid!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Estimates/inventory/",
...
$(".submitqty_"+id).val("Working....");
		...
		if(qty!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Estimates/inventoryupdateqty/",
...
id = $(this).attr('id');
		...
		if(des!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Estimates/inventoryupdatedes/",
...
$('.submitrt').click(function(){
	...
	$(".submitrate_"+id).val("Working....");
		...
		if(rt!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Estimates/inventoryupdaterate/",
...
id = $(this).attr('id');
		...
		if(item!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Estimates/inventoryupdateitem/",
...
var est_id =$("#est_id").text();
		if(total!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Estimates/updateestimate/",
...
var est_id =$("#est_id").text();
		if(item!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Estimates/updateestimateitem/",
