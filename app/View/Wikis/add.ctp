...
<div class="warper container-fluid" style="margin-bottom:100px;">
    ...
    <div class="page-header"><h1>New Wiki Page
        ...
        <div class="row">
            ...
            <div class="col-md-10">
            	<div class="panel panel-default">
                    <div class="panel-heading">New Wiki</div>
                    <div class="panel-body"><br>
        				<?php echo $this->Form->create('Wiki',array('controller'=>'Wikis','action'=>'add','class'=>"validator-form",'id'=>"wizardForm")); ?>
        	
            		<div class="row">                 
						<div class="col-xs-12 col-sm-12">
							<div class="form-group">
								<?php echo $this->Form->input('Wiki.name', array('div'=>false,'class'=>'form-control','required'=>'required','label'=>'Name')); ?>
               					<?php echo $this->Form->input('Wiki.login_id', array('type'=>'hidden','class'=>'form-control','value'=>$this->Session->read('Auth.User.id'))); ?>
							</div>
						</div>
					</div>
					<div class="row">                 
					...
					<div class="row">
				    	<div class="col-xs-12 col-sm-12">
				    	<div class="form-group">
		                	<?php echo $this->Form->button('Create Wiki Page', array('class' => 'btn btn-success pull-left save')); ?>
		            	</div>
		            	</div>
					</div>
