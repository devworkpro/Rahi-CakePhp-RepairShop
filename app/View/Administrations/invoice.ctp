  ...
  <?php echo $this->Flash->render('positive');?>
    <div class="panel panel-white">
      ...
      <div class="panel-body">
        <div class="row">  
          <div class="col-md-9" style="margin-top: -20px;">
              <b><h2><i class="fa fa-gear"></i>    Invoice Settings</h2></b>
          </div>
          <div class="col-md-3">
        ...
        <?php echo $this->Form->create('Administrations',array('controller'=>'Administrations','action'=>'invoice')); ?>
        <div class="row">                 
            ...
            <div class="col-xs-6 col-sm-6" style="margin-top: 15px;">
              ...
              foreach ( $User_menu as $menu ) { 
                      ...
                      if($metch!='')
                      {
                        ...
                        <label>Enable Invoice Module</label>
                        <?php
                      }
                      else
                      {
      ...
      <div class="panel-body">
        ...
        <div class="row">                 
          <div class="col-xs-12 col-sm-12">
            ...
            <?php echo $this->Form->create('Administrations',array('controller'=>'Administrations','action'=>'updateinvoicedisclaimer','class'=>"validator-form",'id'=>"wizardForm")); ?>   
      ...
      if(!empty($Package))
      {
        ...
        if($multilocation == 1)
        {
          ...
          <div class="panel-body">
            <div class="row">  
              <div class="col-md-12" style="margin-top: -20px;">
                  <b><h2>   Transfer All Invoices </h2></b>
                  <hr>
              </div>
            </div><br>
            <div class="row">                 
              <div class="col-xs-12 col-sm-12">
              <?php echo $this->Form->create('Administrations',array('controller'=>'Administrations','action'=>'invoicelocationtransfer')); ?>
                ...
                {
                  ?>
                  <label>From Location (Invoices Only)</label>
                  <?php echo $this->Form->input('TransferLocation.from_invoice', array('type'=>'hidden','div'=>false,'class'=>'form-control','value'=>'default')); ?>
                  <select name="TransferLocation[from_invoice]" class="form-control" disabled="disabled">
                    <option value="default">default</option>
                  </select>              
                  <br>
                  <label>To Location </label>
                  <select name="TransferLocation[to_invoice]" class="form-control">
                    <option value="default">default</option>
                    <?php
                ...
                else
                {
                  ?>
                  <label>From Location (Invoices Only)</label>
                  <?php echo $this->Form->input('TransferLocation.from_invoice', array('type'=>'hidden','div'=>false,'class'=>'form-control','value'=>$TransferLocation['TransferLocation']['to_invoice'])); ?>
                  <select name="TransferLocation[from_invoice]" class="form-control" disabled="disabled">
                    <option value="<?php echo $TransferLocation['TransferLocation']['to_invoice'];?>"><?php 
                    echo $TransferLocation['TransferLocation']['to_invoice'];?></option>
                  </select>
      ...
      <div class="panel-footer">
        <div class="row">
          <div class="col-md-11">
            <?php echo $this->Html->link('Previous',array('controller'=>'Administrations','action'=>'customer'),array('escape'=>false));?>
          </div>
          <div class="col-md-1">
            <?php echo $this->Html->link('Next',array('controller'=>'Administrations','action'=>'estimates'),array('escape'=>false));?>
          </div>
        </div>
      </div>
    </div>
