  ...
  <?php echo $this->Flash->render('positive');?>
    <div class="panel panel-white">
      ...
      <div class="panel-body">
        <div class="row">  
          <div class="col-md-9" style="margin-top: -20px;">
              <b><h2><i class="fa fa-gear"></i>    Customer Settings</h2></b>
          </div>
          <div class="col-md-3">
        ...
        <?php echo $this->Form->create('Administrations',array('controller'=>'Administrations','action'=>'customer')); ?>
        <div class="row">                 
          <div class="col-xs-12 col-sm-12">
            <div class="col-xs-6 col-sm-6" style="margin-top: 15px;">
              ...
              <?php } ?>
              <hr>
              <?php echo $this->Html->link('Customer Custom Fields',array('controller'=>'users','action'=>'customerfields'),array('escape'=>false));?>
              <br><br><br>
              <?php echo $this->Html->link('Asset Custom Fields',array('controller'=>'assets','action'=>'customerassets'),array('escape'=>false));?>
      ...
      <div class="panel-footer">
        <div class="row">
          <div class="col-md-11">
            <?php echo $this->Html->link('Previous',array('controller'=>'Administrations','action'=>'tabs'),array('escape'=>false));?>
          </div>
          <div class="col-md-1">
            <?php echo $this->Html->link('Next',array('controller'=>'Administrations','action'=>'invoice'),array('escape'=>false));?>
          </div>
        </div>
      </div>
    </div>
