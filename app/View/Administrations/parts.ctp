  ...
  <?php echo $this->Flash->render('positive');?>
    <div class="panel panel-white">
      ...
      <div class="panel-body">
        <div class="row">  
          <div class="col-md-9" style="margin-top: -20px;">
              <b><h2><i class="fa fa-gear"></i>        Parts Settings</h2></b>
          </div>
          <div class="col-md-3">
        ...
        <?php echo $this->Form->create('Administrations',array('controller'=>'Administrations','action'=>'parts')); ?>
        <div class="row">                 
            ...
            <div class="col-xs-6 col-sm-6" style="margin-top: 15px;">
              ...
              foreach ( $User_menu as $menu ) { 
                      ...
                      if($metch!='')
                      {
                        ...
                        <label>Enable Parts Module</label>
                        <?php
                      }
                      else
                      {
      ...
      <div class="panel-footer">
        <div class="row">
          <div class="col-md-11">
            <?php echo $this->Html->link('Previous',array('controller'=>'Administrations','action'=>'tickets'),array('escape'=>false));?>
          </div>
          <div class="col-md-1">
            <?php echo $this->Html->link('Next',array('controller'=>'Administrations','action'=>'inventory'),array('escape'=>false));?>
          </div>
        </div>
      </div>
    </div>
