  ...
  <div class="col-xs-9">
    ...
    <div class="panel panel-white">
      <div class="panel-body">
        ...
        <!-- Add New Location -->
        <div id="AddNewMultilocation"> 
          <h2>Add New Location</h2>
          <?php echo $this->Form->create('Administrations',array('controller'=>'Administrations','action'=>'addnewmultilocation','id'=>"wizardForm")); ?> 
            ...
            <hr class="dotted"> 
              ...
              <div class="btn-group">
                <?php echo $this->Form->button("Create Location", array('class' => 'btn btn-success pull-left')); ?>
              </div>
              </div>
            </div>
