  ...
  <?php echo $this->Flash->render('positive');?>
    <div class="panel panel-white">
      ...
      <div class="panel-body">
        <div class="row">  
          <div class="col-md-9" style="margin-top: -20px;">
              <b><h2><i class="fa fa-gear"></i>    Leads Settings</h2></b>
          </div>
          <div class="col-md-3">
        ...
        <?php echo $this->Form->create('Administrations',array('controller'=>'Administrations','action'=>'leads')); ?>
        <div class="row">                 
            ...
            <div class="col-xs-6 col-sm-6" style="margin-top: 15px;">
              ...
              foreach ( $User_menu as $menu ) { 
                      ...
                      if($metch!='')
                      {
                        ...
                        <label>Enable Leads Module</label>
                        <?php
                      }
                      else
                      {
      ...
      <div class="panel-footer">
        <div class="row">
          <div class="col-md-11">
            <?php echo $this->Html->link('Previous',array('controller'=>'Administrations','action'=>'pos'),array('escape'=>false));?>
          </div>
          <div class="col-md-1">
            <?php echo $this->Html->link('Next',array('controller'=>'Administrations','action'=>'employee'),array('escape'=>false));?>
          </div>
        </div>
      </div>
    </div>
