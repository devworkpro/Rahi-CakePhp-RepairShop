									...
									<div id="reminder" style="display: none;"> 
										...
										<?php echo $this->Form->create('Contract',array('controller'=>'Contracts','action'=>'addnewreminder')); ?> 
											...
											<div class="form-group">
												...
												<?php echo $this->Form->input('Reminder.login_id', array('type'=>'hidden','class'=>'form-control','value'=>$this->Session->read('Auth.User.id'))); ?>
											</div>
											</div>
											</div>
										   	<div class="row">                 
...
$('.submit_contract_name').click(function(){
        ...
        if(contract_name!='')
        {
               $.ajax({
               type: "POST",
               url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Contracts/contractnameupdate/",
...
$('.submit_start_date').click(function(){
        ...
        if(start_date!='')
        {
               $.ajax({
               type: "POST",
               url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Contracts/startdateupdate/",
...
$('.submit_end_date').click(function(){
        ...
        if(end_date!='')
        {
               $.ajax({
               type: "POST",
               url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Contracts/enddateupdate/",
...
$('.submit_primary_contact').click(function(){
        ...
        if(primary_contact!='')
        {
               $.ajax({
               type: "POST",
               url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Contracts/primarycontactupdate/",
...
$(document).ready(function() {
	...
	$('.service_level_agreement_select').change(function() {
	    ...
	    if(service_level_agreement!='')
	    {
	        $.ajax({
	        type: "POST",
	        url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Contracts/servicelevelagreementupdate/",
	        // url: "search.php",
...
$(document).ready(function() {
	...
	$('.applie_select').change(function() {
	    ...
	    if(applie!='')
	    {
	        $.ajax({
	        type: "POST",
	        url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Contracts/appliestoallticketsupdate/",
	        // url: "search.php",
...
$('.submit_description').click(function(){
        ...
        if(description!='')
        {
               $.ajax({
               type: "POST",
               url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Contracts/descriptionupdate/",
...
$(document).ready(function(){
	...
	$('#product_name').keyup(function(){
		...
		if(searchid!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Contracts/product/",
 			  // url: "search.php",
