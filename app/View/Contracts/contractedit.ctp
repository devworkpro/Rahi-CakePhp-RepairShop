...
<div class="warper container-fluid" style="margin-bottom:100px;">
  ...
  <div class="page-header"><h1>Edit contract
  ...
  <div class="row">
    ...
    <div class="col-md-10">
    <?php echo $this->Form->create('Contract',array('controller'=>'Contracts','action'=>'contractedit','class'=>"validator-form",'id'=>"wizardForm")); ?>
...
$(document).ready(function(){
    ...
    if(user_id!='')
    {
         $.ajax({
         type: "POST",
         url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/contracts/usernamebyid/",
