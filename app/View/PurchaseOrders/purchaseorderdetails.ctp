						...
						<div class="col-xs-12 col-sm-12">
							<div class="form-group">  
								...
								{	$vendor_id = $Vendor['Vendor']['id']							
									?>
									<p><?php echo $this->Html->link($Vendor['Vendor']['name'],array('controller' => 'Vendors', 'action' => 'vendordetails',$vendor_id),array('escape'=>false,'target'=>"_blank"));?></p>
...
$(document).ready(function() {
	...
	$('.vendor_select').change(function() {
	    ...
	    if(vendor!='')
	    {
	         $.ajax({
	         type: "POST",
	         url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/vendorupdate/",
...
$('.submit_order_date').click(function(){
		...
		if(order_date!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/updateorderdate/",
...
$('.submit_due_date').click(function(){
		...
		if(due_date!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/updateduedate/",
...
$(document).ready(function() {
	...
	$('.submit_paid_date').click(function(){
		...
		if(paid_date!='')
		{
	 		$.ajax({
	 			type: "POST",
	 			url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/updatepaiddate/",
...
$(document).ready(function() {
	...
	$('.submit_number').click(function(){
		...
		if(number!='')
		{
	 		$.ajax({
	 			type: "POST",
	 			url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/updatenumber/",
...
$(document).ready(function() {
	...
	$('.submit_tracking').click(function(){
		...
		if(tracking!='')
		{
	 		$.ajax({
	 			type: "POST",
	 			url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/updatedeliverytracking/",
...
$(document).ready(function() {
	...
	$('.select_').change(function() {
	    ...
	    if(status!='')
	    {
	        $.ajax({
	        type: "POST",
	        url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/statusupdate/",
	        // url: "search.php",
...
$('.shipping_notes_submit').click(function(){
		...
		if(shipping_notes!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/shippingnotesupdate/",
...
$('.general_notes_submit').click(function(){
		...
		if(general_notes!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/generalnotesupdate/",
...
$(document).ready(function() {
	...
	$('.submit_shipping_price').click(function(){
		...
		if(shipping_price!='')
		{
	 		$.ajax({
	 			type: "POST",
	 			url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/updateshippingprice/",
...
$(document).ready(function() {
	...
	$('.submit_other_charges').click(function(){
		...
		if(other_charges!='')
		{
	 		$.ajax({
	 			type: "POST",
	 			url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/updateothercharges/",
...
$(document).ready(function() {
	...
	$('.submit_discount_percent').click(function(){
		...
		if(discount_percent!='')
		{
	 		$.ajax({
	 			type: "POST",
	 			url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/updatediscountpercent/",
...
$(document).ready(function() {
	...
	$('.select_user').change(function() {
	    ...
	    if(user!='')
	    {
	        $.ajax({
	        type: "POST",
	        url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/userupdate/",
	        // url: "search.php",
...
$(document).ready(function() {
	...
	$('.submit_cost').click(function(){
		...
		if(cost!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/updatepurchaseitemcost/",
...
//alert(total);alert(po_id);die();
		if(total!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/PurchaseOrders/updatepurchasetotal/",
