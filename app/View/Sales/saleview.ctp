								...
								<div class="panel-body">
									...
									<table cellpadding="0" cellspacing="0" border="0" id="example1" class="display table" >
				          			...
				          			<tbody>
                						<?php $counter=0;$total=0;$tax=0;$string=''; ?>
                     					...
                     					<td>
                     						<div class="quantity_<?php echo $row_id; ?>">
                     							...
                     							<?php $qty=$Inv['SaleProduct']['quantity'];?>
                     						...
                     						<div style="display:none;" class="qty_edit_<?php echo $row_id;?>" id="<?php echo $row_id; ?>" >
												...
												<input type="hidden"  id="id_<?php echo $row_id;?>" value="<?php echo $Inv['SaleProduct']['id'];?>">
										...
										<td><?php echo $this->Html->link('<i class="btn btn-danger btn-sm fa fa-trash-o"></i>',array('controller' => 'sales', 'action' => 'deletesale',$Inv['SaleProduct']['id'],$userid),array('escape'=>false,'confirm' => 'Are you sure you wish to delete this Item?'));?></td>
...
$(document).ready(function(){
	...
	//alert(id);
		...
		if(pro_id!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Sales/lineitem/",
...
$(document).ready(function(){
	...
	$('#get_data_customer').keyup(function(){
		...
		if(searchid!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Sales/customer/",
...
$(document).ready(function(){
	...
	$('#product_name').keyup(function(){
		...
		if(searchid!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Sales/inventory/",
...
id = $(this).attr('id');
		...
		if(qty!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Sales/inventoryupdate/",
...
<script type="text/javascript">
	...
	$('.clear').click(function(){
		...
		if(userid!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Sales/deleteinventory/",
