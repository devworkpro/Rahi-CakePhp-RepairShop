...
<div class="warper container-fluid" style="margin-bottom:100px;">
    ...
    <div class="page-header"><h1>Edit Vendor
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="panel panel-default">
                    <div class="panel-heading">Editing vendor</div>
                    <div class="panel-body"><br>
              <?php echo $this->Form->create('Vendor',array('controller'=>'Vendors','action'=>'vendoredit','class'=>"validator-form",'id'=>"wizardForm")); ?>
          ...
          <div class="row">
              <div class="col-xs-12 col-sm-12">
                <div class="form-group">
                  <?php echo $this->Form->button('Update Vendor', array('class' => 'btn btn-success pull-left')); ?>

                   <?php echo $this->Html->link('Show',array('controller' => 'Vendors', 'action' => 'vendordetails',$Vendor['Vendor']['id']),array('escape'=>false,'class'=>'btn btn-primary pull-right'));?>
                </div>
              </div>
          </div>
