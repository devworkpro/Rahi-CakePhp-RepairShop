...
<div class="warper container-fluid" style="margin-bottom:100px;">
	...
	<div class="row">
		...
		<!-- Purchase Order -->
		<div class="panel panel-default col-md-6 purchaseorder">
		...
		<!-- Contacts -->
		<div class="panel panel-default col-md-6 contacts">
	    <div class="panel-heading clearfix">
...
$(document).ready(function() {
	$('#addnewcontact').click(function(){		
		...
		$.ajax({
 			type: "POST",
 			url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Vendors/addnewcontact/",
