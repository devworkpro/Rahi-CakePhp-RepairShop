...
<?php echo $this->Html->link('<p class="btn btn-success btn-sm">New RMA</p>',array('controller'=>'Rmas','action'=>'add'),array('escape'=>false));?> 

</div>
</div>
<div class="page-header text-right"></div>
                    ...
                    <div class="panel-body">
                        ...
                        <?php foreach($Rma as $Rmas) {
                          ...
                          <?php  $user_id= $Rmas['Rma']['user_id'];?>
                             ...
                             <td><?php echo $Rmas['Rma']['vendor'];?></td>

                             <td><?php echo $Rmas['Rma']['vendor_name'];?></td>

                             <td>
                                <div class="status_<?php echo $row_id; ?>">
                                ...
                                <div style="display:none;" class="qty_edit_<?php echo $row_id;?>" id="<?php echo $row_id; ?>" >
                                  <form class="place" action="javascript:void(0);">
                                    <select  id="<?php echo $row_id; ?>" class="select_" >
                                      <option> New </option>
...
id = $(this).attr('id');
    ...
    if(status!='')
    {
         $.ajax({
         type: "POST",
         url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Rmas/statusupdate/",
