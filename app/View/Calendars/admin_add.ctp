			...
			<?php foreach($Appointments as $App){  ?>	
				{
					...
					url: 'http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Appointments/appointmentdetails/<?php echo $App['Appointment']['id'];?>'
				},
			<?php } ?>	
...
var app_id=$(this).val();
    if(app_id!='')
    {
        $.ajax({
        type: "POST",
        url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Calendars/schedule/",
        data: { app_id : app_id},
        success: function(data)
        {
