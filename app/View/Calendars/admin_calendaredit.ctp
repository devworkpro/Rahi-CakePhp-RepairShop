                ...
                <div class="panel-body">
                    ...
                    <div class="row">                 
                        <div class="col-xs-12 col-sm-12">
                            ...
                            <?php echo $this->Form->input('Rma.vendor', array('options' => array('' => ''),'class'=>'form-control','label'=>'Vendor')); ?>
                    ...
                    <div class="row">                 
                        <div class="col-xs-12 col-sm-12">
                          ...
                          <div class='input-group date' id="datetimepicker1" >
                              <?php echo $this->Form->input('Rma.submitted', array('class'=>'form-control','div'=>false, 'label'=>false)); ?>
                    ...
                    <div class="row">                 
                        <div class="col-xs-12 col-sm-12">
                          ...
                          <div class='input-group date' id="datetimepicker2" >
                              <?php echo $this->Form->input('Rma.returned', array('class'=>'form-control','div'=>false, 'label'=>false)); ?>
                              <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                          </div>
