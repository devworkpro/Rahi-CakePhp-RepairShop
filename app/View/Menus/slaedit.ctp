...
<div class="warper container-fluid" style="margin-bottom:100px;">
    ...
    <div class="page-header"><h1>Edit SLA
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="panel panel-default">
                    <div class="panel-heading">Edit SLA</div>
                    <div class="panel-body"><br>
                <?php echo $this->Form->create('Sla',array('controller'=>'Slas','action'=>'slaedit','class'=>"validator-form",'id'=>"wizardForm")); ?>
