        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
 					<h2>New RMA</h2>
					<?php echo $this->Form->create('Rma',array('controller'=>'Rmas','action'=>'add','id'=>"wizardForm")); ?>
						
					
					<div class="row">                 
                    	<div class="col-xs-12 col-sm-12">
							<div class="form-group">
								<?php echo $this->Form->input('Rma.login_id', array('type'=>'hidden','div'=>false,'class'=>'form-control','value'=>$this->Session->read('Auth.User.id'))); ?>
					...
					<div class="row">                 
						...
						<hr class="dotted">	
							<div class="btn-group">
								<?php echo $this->Form->button('Save RMA', array('class' => 'btn btn-success pull-left')); ?>
							</div><br><br>
...
$(document).ready(function(){
	...
	$('#get_data').keyup(function(){
		...
		if(searchid!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/Rmas/rma/",
