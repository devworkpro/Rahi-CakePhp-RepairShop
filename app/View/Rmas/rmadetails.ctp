			...
			<div class="row">  
				<div class="col-xs-12 col-sm-12">
					<div class="form-group">
							...
							<hr class="dotted">
							<?php echo $this->Html->link('Edit',array('controller' => 'Rmas', 'action' => 'rmaedit',$Rmas['Rma']['id']),array('escape'=>false,'class'=>'btn btn-primary'));?>   |   
                   			<?php echo $this->Html->link('Back',array('controller' => 'Rmas', 'action' => 'rmalist'),array('escape'=>false, 'class'=>'btn btn-default'));?>
