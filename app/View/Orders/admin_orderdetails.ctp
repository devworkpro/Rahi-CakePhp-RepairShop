...
$('.submit').click(function(){
		...
		if(identification!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Orders/identificationupdate/",
...
$('.general_notes_submit').click(function(){
		...
		if(general_notes!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Orders/generalnotesupdate/",
...
//alert(total);alert(order_id);die();
		if(total!='')
		{
 			   $.ajax({
 			   type: "POST",
 			   url: "http://112.196.42.180/projects/repairshopsaas/repairshopsaas/admin/Orders/updatepurchasetotal/",
