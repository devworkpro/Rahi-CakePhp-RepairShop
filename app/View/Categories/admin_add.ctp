        	...
        	<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="row">                 
						<div class="col-xs-12 col-sm-12">
							<div class="form-group">
								...
								<?php	echo $this->Form->input('Category.user_id', array('div'=>false,'class'=>'form-control', 'type'=>'hidden','value'=>$this->Session->read('User_id'))); ?>
		       				</div>
						</div>
					</div>
					...
					<div class="row">                 
						<div class="col-xs-12 col-sm-12">
							<div class="form-group">
								<?php echo $this->Form->input('Category.description', array('type'=>'textarea','class'=>'form-control','placeholder' => 'Enter Your category description','style'=>'height: 70px;')); ?>
