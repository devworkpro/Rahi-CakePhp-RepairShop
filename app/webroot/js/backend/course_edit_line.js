 ...
 $().ready(function() {
     ...
     $('.score-control').click(function(event) {
         ...
         if (id == 'finishButton') {
             if (confirm('Is Start Location and Finish location are same?')) {
                 var marker = markersArray[0]; // find the marker by given id
     ...
     $('#createLine').click(function(event) {

         if (poly != undefined) {
             poly.setMap(null);
         }
         var sortingLocation = locations;
         var checkSequence;
         var coordinates = [];
         sortingLocation.sort(function(a, b) {
             var a1 = parseInt(a.controlid),
                 b1 = parseInt(b.controlid);
             if (a1 == b1) return 0;
             return a1 > b1 ? 1 : -1;
         });
         $.each(sortingLocation, function(index, val) {
             if (val.controlid != index && val.controlid != 111) {
                 checkSequence = 'no';
             }
         });
         ...
         if (checkSequence != 'no') {
             ...
             if(sortingLocation != undefined){

             if (sortingLocation[sortingLocation.length - 1].type != 'f') {
             ...
             alert('Please Enter Controls in Sequence');
         }
